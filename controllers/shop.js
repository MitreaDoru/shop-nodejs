...
const stripe = require('stripe')("sk_test_51NkphOLjKMGaNvoNSMORGO7Xv0dQ7mZndyNteeqGvVPJNQZDIoZJnaTl3hcZB7ioD6hLgNJHQwIWIs8aHl7FM63n00clx6LZzQ")
...
exports.getCheckout = (req, res, next) => {
    ...
    req.user.populate('cart.items.productId')
        ...
        .then(session => {
            ...
            res.render('shop/checkout', { pageTitle: 'Checkout', path: '/checkout', products: products, totalSum: total.toFixed(2), sessionId: session.id })
        })
        .catch(err => {
            const error = new Error(err)
            error.httpStatusCode = 500
